...
class BaseOwaspAdminMixin:
    ...
    def get_base_list_display(self, *additional_fields):
        ...
        Args:
            *additional_fields: Additional fields to include in the list display.

        Returns:
            tuple: Combined tuple of name field, additional fields, and standard fields.
    ...
    def get_base_search_fields(self, *additional_fields):
        ...
        Args:
            *additional_fields: Additional fields to include in search.

        Returns:
            tuple: Combined tuple of standard search fields and additional fields.
...
class EntityChannelInline(GenericTabularInline):
    ...
    def formfield_for_dbfield(self, db_field, request, **kwargs):
        ...
        Returns:
            FormField: Configured form field with custom widget.
...
class GenericEntityAdminMixin(BaseOwaspAdminMixin):
    ...
    def get_queryset(self, request):
        ...
        Returns:
            QuerySet: Prefetched queryset with related repository data.
    ...
    def custom_field_github_urls(self, obj):
        ...
        Returns:
            str: HTML links to GitHub repositories.
    ...
    def custom_field_owasp_url(self, obj):
        """Return formatted OWASP site link for the entity.
    ...
    def _format_github_link(self, repository):
        ...
        Returns:
            str: HTML link to the GitHub repository.
